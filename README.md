...
Estos son algunos ejercicios básicos de programación en C para practicar estructuras de control y asentar conceptos básicos. Se corresponden con mi primer año de Ingeniería del Software en U-Tad. La herramienta que he usado para compilar el código es TDM-GCC 4.9.2 (64-Bit).
